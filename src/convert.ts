// import {
//   type NodeType,
//   type TanaIntermediateAttribute,
//   type TanaIntermediateNode,
//   type TanaIntermediateFile,
//   type TanaIntermediateSummary
// } from './types'
// import {
//   DATE_REGEX,
//   dateStringToYMD,
...
//   replaceMoonJotSyntax,
//   setNodeAsDone,
//   setNodeAsTodo
// } from './utils'

// export class MoonJotConverter {
//   private readonly nodesForImport = new Map<string, TanaIntermediateNode>()
//   private readonly originalNodeNames = new Map<string, string>()
//   private readonly attrMap = new Map<string, TanaIntermediateAttribute>()

//   private readonly topLevelMap = new Map<string, TanaIntermediateNode>()

//   private readonly summary: TanaIntermediateSummary = {
//     leafNodes: 0,
//     topLevelNodes: 0,
//     totalNodes: 0,
//     calendarNodes: 0,
...
//   convert (markdown: string): TanaIntermediateFile | undefined {
//     const rootLevelNodes: TanaIntermediateNode[] = []
//     try {
//       const lines: string[] = markdown.split('\n')

//       for (let i = 0; i < lines.length; i++) {
//         const node = this.moonJotToIntermediate(lines[i], undefined)
//         if (node) {
...
//       if (!nodeForImport.refs?.includes(g.content)) {
...
//   private moonJotToIntermediate (line: string, parentNode?: TanaIntermediateNode): TanaIntermediateNode | undefined {
...
//       intermediateNode.name = replaceMoonJotSyntax(intermediateNode.name)
//     }

//     this.originalNodeNames.set(node.id, intermediateNode.name)
//     this.nodesForImport.set(node.id, intermediateNode)

//     // convert MoonJot properties to Tana fields
//     if (node.properties) {
//       if (node['page-name'] && hasDuplicateProperties(node, node.children?.[0])) {
//         // moonJot properties appear to be duplicated in the page node and the first child node
...
//         const child = this.moonJotToIntermediate(node.children[j], intermediateNode)
//         if (child) {
